...
function editRow(event) {
    ...
    if (event.target.innerHTML === "Edit") {
        ...
        event.target.parentElement.getElementsByClassName("delete-btn")[0].innerHTML = "Cancel";
    }
    else {
        ...
        event.target.parentElement.getElementsByClassName("delete-btn")[0].innerHTML = "Delete";
    }
}
...
function deleteRow(event) {
    ...
    if (event.target.innerHTML === "Delete") {
        ...
        event.target.parentElement.getElementsByClassName("edit-btn")[0].innerHTML = "Edit";
    }
}